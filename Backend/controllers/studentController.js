  ...
  try {
    ...
    if (isTeacher) {
      return res.status(400).json({
        message:
          "This email belongs to a Teacher account and cannot be invited as a student.",
      });
    }
    ...
    const studentData = student.toObject();  // Convert Mongoose document to a plain object
...
exports.updateStudentProfile = async (req, res) => {
  try {
    ...
    res.status(200).json(student); // Return the full updated object
  } catch (err) {
